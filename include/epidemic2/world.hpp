...
class World{
  ...
  public:
    ...
    void generate_path(int mean, int dev, std::vector<double> weights, std::vector<Location *> &path, Random& rng); //generate path from selecting from all green clusters
};
