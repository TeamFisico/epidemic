...
class Person
{
  ...
  public:
    ...
    Person(Status current_status,Status next_status, int cluster_label, Location home, Position current_position, int target_index,
           bool is_at_home, bool going_home,int stay_time);
    Person(); // default constructor
    //////////////////////////////////////////////////////////////////////////////////////////////////////////////
    Status current_status() const { return curr_status; }
    Status new_status() const { return next_status; }
    ...
    //////////////////////////////////////////////////////////////////////////////////////////////////////////////
    void set_current_status(Status st) { curr_status = st; }
    void set_new_status(Status st) { next_status = st; }
