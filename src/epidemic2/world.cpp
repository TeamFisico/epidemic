...
World::World(double Side_length, int number_of_clusters, int number_of_location, int S, int E, int I, int R)
{
    ...
    for(int i = 0; i < number_of_clusters; ++i){
        clusters.emplace_back(S_pop_num.operator[](i), E_pop_num.operator[](i), I_pop_num.operator[](i), R_pop_num.operator[](i), loc_num.operator[](i),cluster_areas.operator[](i),Color::Green, i);
    }
}
